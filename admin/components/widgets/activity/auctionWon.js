    ...
    <div className="grid gap-0.5 relative justify-center">
      <div className="sm:py-6 grid justify-center text-center py-4 px-2.5 gap-0 relative z-20">
        ...
        <div className="grid gap-0.313">
          ...
          <div className="sm:text-lg sm:leading-5	px-6 font-base font-semibold bg-gray-100 leading-1.2">
      ...
      <div className="sm:bottom-14 h-px w-full left-0 bottom-10 absolute bg-gray-300"></div>
    </div>
  );
};
