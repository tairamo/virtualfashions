...
export const MESSAGE = "Plase enter message";
...
export const FETCHING_DATA_ERROR = "Error while faching data";
...
export const REQUEST_LISTING_ERROR = "Error while listing art for auction";
