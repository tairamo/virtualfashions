export default function CreatorCard({ creator }) {
  return (
    <div className="box-border bg-white min-w-0 transition-all duration-300 ease-trans-expo flex flex-col shadow-3xl rounded-xl overflow-hidden flex-1 hover:shadow-ho3xl transform-4px cursor-pointer" onClick={() => window.open(creator?.opensea_link)}>
            ...
            <div className="relative mx-6">
              <div className="p-2 bg-white h-24 w-24 absolute left-0 transform -translate-y-2/4	flex rounded-full">
                <div
                  ...
                  style={{ backgroundImage: `url(${creator.profile_photo})` }}
                ></div>
              </div>
            </div>
          </div>
