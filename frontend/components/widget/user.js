  ...
  return (
    <div className="flex">
      <Link href={`/${user?.username}`}>
        <div className="sm:p-2.5 sm:pr-5 bg-white flex items-center p-2 shadow-3xl rounded-full transition-all duration-300 ease-trans-expo transform-2px hover:shadow-ho3xl pr-5 cursor-pointer">
          <div
