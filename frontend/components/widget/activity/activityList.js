  ...
  return (
    <div className="sm:px-6 sm:items-center flex p-5 rounded-md bg-white relative shadow-3xl">
      ...
      <a
        ...
        className="absolute flex items-center no-underline text-gray-600 cursor-pointer z-10 sm:ml-6 sm:relative sm:right-0 sm:bottom-0 right-5 bottom-5 hover:text-black"
      >
        <GotoIcon />
      </a>
    </div>
